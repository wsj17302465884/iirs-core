...
namespace IIRS.Utilities.AuthHelper
{
    ...
    public class PermissionHandler : AuthorizationHandler<PermissionRequirement>
    {
        ...
        public PermissionHandler(IRoleModulePermissionRepository roleModulePermissionRepository, IAuthenticationSchemeProvider schemes, IHttpContextAccessor accessor)
        {
            Schemes = schemes;
            ...
            if (httpContext != null)
            {
                ...
                if (defaultAuthenticate != null)
                {
                    ...
                    if (result?.Principal != null)
                    {
                        ...
                        //var data = _dataRepository.GetRoleModulePermissions();
                        //var list = (from item in data
                        //            where item.IsDeleted == false
                        //            orderby item.ID
                        //            select new PermissionItem
