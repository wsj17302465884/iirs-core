...
namespace IIRS.Models.EntityModel.BDC
{
    ...
    ///
    ///</summary>
    [SugarTable("FC_H_QSDC", SysConst.DB_CON_BDC)]
    public partial class FC_H_QSDC
    {
        ...
        /// </summary>
        [SugarColumn(IsIgnore = true)]
        public string FCZ_ghyt { get; set; }
        [SugarColumn(IsIgnore = true)]
        public string FCZ_ghyt_zwm { get; set; }

        [SugarColumn(IsIgnore = true)]
        public string FCZ_TDQLLX { get; set; }
        [SugarColumn(IsIgnore = true)]
        public string FCZ_TDQLLX_zwm { get; set; }
        [SugarColumn(IsIgnore = true)]
        public string FCZ_TDQLXZ { get; set; }
        [SugarColumn(IsIgnore = true)]
        public string FCZ_TDQLXZ_zwm { get; set; }
        #endregion
        ...
        /// Nullable:True
        /// </summary>           
        public string ZD_TDQLLX { get; set; }
        [SugarColumn(IsIgnore = true)]
        public string ZD_TDQLLX_zwm { get; set; }
        /// <summary>
        /// Desc:Z土地权利性质
        /// Default:
        /// Nullable:True
        /// </summary>           
        public string ZD_TDQLXZ { get; set; }

        [SugarColumn(IsIgnore = true)]
        public string ZD_TDQLXZ_zwm { get; set; }
        /// <summary>
        /// Desc:zd表土地用途
        /// Default:
        /// Nullable:True
        /// </summary>           
        public string ZD_TDYT { get; set; }
        [SugarColumn(IsIgnore = true)]
        public string ZD_tdyt_zwm { get; set; }
        /// <summary>
        /// 宗地表中批准土地用途
        /// </summary>
        [SugarColumn(IsIgnore = true)]
        public string ZD_pztdyt { get; set; }
        [SugarColumn(IsIgnore = true)]
        public string ZD_pztdyt_zwm { get; set; }
        /// <summary>
        /// 宗地表中实际土地用途
        /// </summary>
        [SugarColumn(IsIgnore = true)]
        public string ZD_sjtdyt { get; set; }
        [SugarColumn(IsIgnore = true)]
        public string ZD_sjtdyt_zwm { get; set; }
        /// <summary>
        /// 宗地表权利类型
        /// </summary>
        [SugarColumn(IsIgnore = true)]
        public string ZD_qllx { get; set; }
        [SugarColumn(IsIgnore = true)]
        public string ZD_qllx_zwm { get; set; }
        /// <summary>
        /// 宗地表权利性质
        /// </summary>
        [SugarColumn(IsIgnore = true)]
        public string ZD_qlxz { get; set; }
        [SugarColumn(IsIgnore = true)]
        public string ZD_qlxz_zwm { get; set; }
        #endregion
        #endregion
        ...
        [SugarColumn(IsIgnore = true)]
        public DateTime? zd_TDZZRQ { get; set; }
