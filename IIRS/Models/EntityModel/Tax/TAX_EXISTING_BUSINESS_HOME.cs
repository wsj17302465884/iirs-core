...
namespace IIRS.Models.EntityModel.Tax
{
    ...
    ///
    ///</summary>
    [SugarTable("TAX_EXISTING_BUSINESS_HOME", SysConst.DB_CON_TAX)]
    public partial class TAX_EXISTING_BUSINESS_HOME
    {
           public TAX_EXISTING_BUSINESS_HOME(){
        ...
        public List<TAX_EXISTING_HOME_BUS_BUYER> GMFXX { get; set; } = new List<TAX_EXISTING_HOME_BUS_BUYER>();

        /// <summary>
        /// 出卖方信息
        /// </summary>
        [SugarColumn(IsIgnore = true)]
        public List<TAX_EXISTING_HOME_BUS_SELLER> CMFXX { get; set; } = new List<TAX_EXISTING_HOME_BUS_SELLER>();
        /// <summary>
        /// 受理编号
        /// </summary>
        public string SLBH { get; internal set; }
        /// <summary>
        /// 判断类型 0 住宅 1 商业
        /// </summary>
