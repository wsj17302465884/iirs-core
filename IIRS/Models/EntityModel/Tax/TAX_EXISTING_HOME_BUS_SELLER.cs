...
namespace IIRS.Models.EntityModel.Tax
{
    ...
    ///
    ///</summary>
    [SugarTable("TAX_EXISTING_HOME_BUS_SELLER", SysConst.DB_CON_TAX)]
    public partial class TAX_EXISTING_HOME_BUS_SELLER
    {
           public TAX_EXISTING_HOME_BUS_SELLER(){
        ...
        public object SLBH { get; internal set; }
    }
}
