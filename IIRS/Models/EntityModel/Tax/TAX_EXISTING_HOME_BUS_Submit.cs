...
{
    [SugarTable("TAX_EXISTING_HOME_BUS_Submit", Utilities.Common.SysConst.DB_CON_IIRS)]
    public class TAX_EXISTING_HOME_BUS_Submit
    {
        public TAX_EXISTING_HOME_BUS_Submit()
        {
